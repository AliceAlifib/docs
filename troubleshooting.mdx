...
<AccordionGroup>
  ...
  <Accordion title="The starter plan it generated is wrong">
    Expected. It is a first draft read out of what you described and what is in your code — roughly right, specifically wrong. Drag, rename and delete until it is your real plan. If it is *badly* wrong, tell us: that is a signal about the inference, and we want it.
  </Accordion>
  ...
  <Accordion title="My factory map looks out of date">
    Beta maps do not yet redraw themselves as a repository drifts. If your code has changed shape substantially, tell us and we will rebuild the map.
  </Accordion>
...
Message us directly. That is the beta arrangement: you get the product early, we get to watch it meet reality.
