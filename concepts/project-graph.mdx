...
The maps, the queue, the chat, and the review inbox are views of one thing: the **project graph**.

It holds the shape of the work and the record of it, connected. One system.
...
That loop is the product. The maps are how you see your work and your system; [the knowledge view](/using/knowledge) is how you see the links themselves — what cites what, what corrected what, and where your reasoning actually connects.
